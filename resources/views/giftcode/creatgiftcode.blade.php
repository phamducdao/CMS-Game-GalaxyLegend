...
@section('noidung')
    ...
    <!-- Content Wrapper -->
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Creatgiftcode</h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <input readonly  type="text" name="giftcode" class="giftcode" value="{{$a[0]}}">
                    <i class="fa fa-plus-circle" onclick="gentext();"></i>
                </div>
                <br>
                <div>
                    <label>Playerid:</label>
                    <input  type="number" name="playerid" class="test">
                </div>
                <br>
                <div>
                    <label>Reward:</label>
                    <input  type="text" name="reward" class="test" value="{{ old('reward')}}">
